    ...
    <div style={{ padding: '20px', maxWidth: '600px' }}>
      ...
      <div style={{
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px' }}>
          <div>总商品数量: <strong>{totalItems}</strong></div>
          <div>总价格: <strong>¥{totalPrice.toFixed(2)}</strong></div>
          <div>平均价格: <strong>¥{averagePrice.toFixed(2)}</strong></div>
          <div>购物车状态: <strong>{isEmpty ? '空' : '有商品'}</strong></div>
        </div>
      </div>
