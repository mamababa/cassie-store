...
import { themeStore, switchTheme, switchLanguage, increaseFontSize, decreaseFontSize } from './themeStore';

function ThemeDemo() {
  // 使用选择性订阅，监听我们需要的字段
  const { theme, language, fontSize, isDarkMode, displayName } =
    themeStore.useGetState(['theme', 'language', 'fontSize', 'isDarkMode', 'displayName']);
